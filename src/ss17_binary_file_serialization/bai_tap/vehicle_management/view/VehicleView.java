...
import ss17_binary_file_serialization.bai_tap.vehicle_management.regex.CheckMotorbikeRegex;
...
public class VehicleView {
    ...
    public Truck inputTruck() {
        ...
        } while (!CheckCarRegex.checkCarRegex(vehicleId));
    ...
    public Motorbike inputMotorbike() {
        ...
        do {
            System.out.println("Nhập biển kiểm soát: ");
            vehicleId = sc.nextLine();
        } while (!CheckMotorbikeRegex.checkMotorbikeID(vehicleId));
        System.out.println("Nhập tên hãng sản xuất: ");
        String branchName = sc.nextLine();
        System.out.println("Nhập năm sản xuất: ");
        int year = Integer.parseInt(sc.nextLine());
